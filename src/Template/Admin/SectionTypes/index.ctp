  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <?= __('Section Types') ?> <span class="badge badge-info"><?= $this->Paginator->counter('{{count}}')?></span>
      </li>
    </ul>
          ...
          <tbody>
            <?php foreach ($sectionTypes as $sectionType): ?>
              <tr>
                  ...
                  <div class="btn-group">
                    <?= $this->Html->link('<i class="material-icons">visibility</i>', ['action' => 'view', $sectionType->id],['class' => 'btn btn-xs btn-simple btn-info btn-icon edit','escape' => false]) ?>
